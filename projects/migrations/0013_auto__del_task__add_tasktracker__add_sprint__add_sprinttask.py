...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TaskTracker'
        db.create_table('projects_tasktracker', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('projects', ['TaskTracker'])

        # Adding model 'Sprint'
        db.create_table('projects_sprint', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deadline_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('projects', ['Sprint'])

        # Adding model 'SprintTask'
        db.create_table('projects_sprinttask', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('tracker', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tracker_tasks', to=orm['projects.TaskTracker'])),
            ...
            ('assigner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tasks', to=orm['projects.ProjectMember'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='my_own_task', to=orm['projects.ProjectMember'])),
            ('deadline_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('sprint', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sprint_tasks', to=orm['projects.Sprint'])),
        ))
        db.send_create_signal('projects', ['SprintTask'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'TaskTracker'
        db.delete_table('projects_tasktracker')

        # Deleting model 'Sprint'
        db.delete_table('projects_sprint')

        # Deleting model 'SprintTask'
        db.delete_table('projects_sprinttask')
