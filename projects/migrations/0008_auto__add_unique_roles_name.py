...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Roles', fields ['name']
        db.create_unique('projects_roles', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Roles', fields ['name']
        db.delete_unique('projects_roles', ['name'])
