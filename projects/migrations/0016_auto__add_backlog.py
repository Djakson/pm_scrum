...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('projects_backlog', (
            ('sprint_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['projects.Sprint'], unique=True, primary_key=True)),
        ))
    ...
    models = {
        ...
        'projects.backlog': {
            'Meta': {'object_name': 'BackLog', '_ormbases': ['projects.Sprint']},
            'sprint_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['projects.Sprint']", 'unique': 'True', 'primary_key': 'True'})
        },
        'projects.project': {
